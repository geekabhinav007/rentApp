                    ...
                    <div className="flex-shrink-0 flex px-2 py-3 items-center space-x-8 flex-1 justify-end justify-self-end">
                        ...
                        {isLoggedIn && (
                            <>
                                ...
                                <button className="text-white bg-green-600 hover:bg-green-800 inline-flex items-center justify-center px-3 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm" onClick={handleOrder}>Orders</button>
